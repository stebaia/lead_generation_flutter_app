class AutogeneratedHistoryCaScanModel {
  SoapEnvelope? soapEnvelope;

  AutogeneratedHistoryCaScanModel({this.soapEnvelope});

  AutogeneratedHistoryCaScanModel.fromJson(Map<String, dynamic> json) {
...
class SoapBody {
  ...
  SoapBody.fromJson(Map<String, dynamic> json) {
    historyResponse = json['HistorycaResponse'] != null
        ? new HistoryResponse.fromJson(json['HistorycaResponse'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.historyResponse != null) {
      data['HistorycaResponse'] = this.historyResponse!.toJson();
    }
    return data;
  }
}
...
class HistoryResponse {
  ...
  HistoryResponse.fromJson(Map<String, dynamic> json) {
    historyResult = json['HistorycaResult'] != null
        ? new HistoryResult.fromJson(json['HistorycaResult'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.historyResult != null) {
      data['HistorycaResult'] = this.historyResult!.toJson();
    }
    return data;
  }
}
