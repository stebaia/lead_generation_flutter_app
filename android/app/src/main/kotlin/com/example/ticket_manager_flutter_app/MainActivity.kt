...
class MainActivity: FlutterActivity() {
    ...
    private fun createDataWedgeProfileDisabled(profileName: String, enabled: String) {
        ...
        profileConfig.putString("SCANNER_INPUT_PLUGIN", "DISABLE_PLUGIN");
        profileConfig.putString("PROFILE_ENABLED", "false") //  These are all strings
